...
},beforePageText:"第",afterPageText:"页,共{pages}页",displayMsg:"当前显示从{from}到{to},共{total}条",nav:{first:{iconCls:"pagination-first",handler:function(){
...
$.fn.validatebox.defaults={required:false,validType:null,validParams:null,delay:200,interval:200,missingMessage:"必须填写.",invalidMessage:null,tipPosition:"right",deltaX:0,deltaY:0,novalidate:false,editable:true,disabled:false,readonly:false,validateOnCreate:true,validateOnBlur:false,events:{focus:_4ab,blur:_4af,mouseenter:_4b2,mouseleave:_4b5,click:function(e){
var t=$(e.data.target);
